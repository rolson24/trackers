...
class TrackingMetric(abc.ABC):
    ...
    def name(self) -> str:
        ...
        raise NotImplementedError(
            "Subclasses must implement the 'name' property to return the metric name."
        )
        pass
    ...
    def compute(
        ...
        """
        raise NotImplementedError(
            "Subclasses must implement the 'compute' method to calculate metrics."
        )
        pass
    ...
    def aggregate(
        ...
        """
        # Default implementation: Simple averaging if results are numeric
